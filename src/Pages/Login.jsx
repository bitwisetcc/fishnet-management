...
function Login() {
  ...
  return (
    <article className="flex items-center justify-center h-[100vh] relative">
      ...
      <form className="bg-slate-100 text-slate-800 border border-slate-300 rounded-lg p-9 shadow-lg z-10 flex w-2/3">
        ...
        <section className="flex-1">
          ...
          <div className="flex flex-col mt-6 gap-5">
            ...
            <a href="/reset-password" className="text-[#2EC4B6]">Esqueceu a senha?</a>
            <button type="submit" className="bg-[#2EC4B6] rounded-lg py-2 shadow-sm hover:brightness-90 transition-all duration-300">Login</button>
          </div>
        </section>
      </form>
    </article>
